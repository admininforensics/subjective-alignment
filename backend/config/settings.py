...
DEFAULT_FROM_EMAIL = os.environ.get("DEFAULT_FROM_EMAIL", "noreply@subjective-alignment.local")

# Temporary testing bypass: auto-assign licences and skip activation UI (set False before production).
SKIP_LICENCE_REQUIREMENT = os.environ.get("SKIP_LICENCE_REQUIREMENT", "False").lower() in {
    "1",
    "true",
    "yes",
    "on",
